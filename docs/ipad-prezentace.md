...
- Po 30 sekundách bez smysluplného pohybu a bez dotyku se zobrazí černá plocha a systémový jas klesne na minimum. Nehybný iPad usne i tehdy, když zůstane nakloněný.
...
- Pohyb nebo dotyk obnoví jas a simulaci. Dotyk probouzející černou plochu nemění ovládací prvky pod ní. Obsah kaše se zachová a doba klidu se nedopočítává.
